...
export default function createRouter<Config extends BaseConfig>(
  ...
  return router({
    createMany: procedure
      .input($Schema.ServiceInputSchema.createMany.optional())
    ...
    deleteMany: procedure
      .input($Schema.ServiceInputSchema.deleteMany.optional())
      .mutation(async ({ ctx, input }) =>
    ...
    findFirst: procedure
      .input($Schema.ServiceInputSchema.findFirst.optional())
      .query(({ ctx, input }) =>
        checkRead(db(ctx).service.findFirst(input as any)),
      ),

    findMany: procedure
      .input($Schema.ServiceInputSchema.findMany.optional())
      .query(({ ctx, input }) =>
    ...
    count: procedure
      .input($Schema.ServiceInputSchema.count.optional())
      .query(({ ctx, input }) =>
        checkRead(db(ctx).service.count(input as any)),
      ),
  })
}
...
> {
  ...
  findMany: {
    ...
    useInfiniteQuery: <T extends Prisma.ServiceFindManyArgs>(
      input?: Omit<
        Prisma.SelectSubset<T, Prisma.ServiceFindManyArgs>,
        'cursor'
      >,
      opts?: UseTRPCInfiniteQueryOptions<
        string,
  ...
  count: {
    useQuery: <
      T extends Prisma.ServiceCountArgs,
      TData = 'select' extends keyof T
        ? T['select'] extends true
          ? number
          : Prisma.GetScalarType<
              T['select'],
              Prisma.ServiceCountAggregateOutputType
            >
        : number,
    >(
